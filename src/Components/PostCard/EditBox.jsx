        ...
        {author === uid ? (
          <>
            <div className="editBox flexBox" onClick={toggleEditModal}>
              <img src={"/Images/edit_icon.png"} alt="editIcon" />
              <p>Edit Post</p>
            </div>
            {image && (
              <div className="editBox flexBox" onClick={handleSetProfile}>
                <img src={"/Images/plus_icon.png"} alt="setIcon" />
                <p>Set as Profile Pic</p>
              </div>
            )}
            <div
              className="editBox editPost1 flexBox"
              onClick={toggleDeleteModal}
            >
              <img src={"/Images/plus_icon.png"} alt="removeIcon" />
              <p>Delete Post</p>
            </div>
            {JSON.stringify(favorites).includes(id) ? (
              <div className="editBox flexBox" onClick={handleRemoveFavorite}>
                <FavIcon />
