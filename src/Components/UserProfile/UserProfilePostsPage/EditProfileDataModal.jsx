...
function EditProfileDataModal({ toggleEditUserDetailsModalState }) {
  ...
  return (
    <div
      className="postsPageEditUserDetailsModalContainer"
    ...
    >
      <PopUp className="postsPageEditUserDetailsModalBox">
        <div className="postsPageEditUserDetailsModalHeader flexBox">
          <h1 className="postsPageEditDetailsModalHeaderNamePlate">
            Edit Details
          </h1>
          <div
            className="editUserDetailsModalCloseIconBox flexBox"
            onClick={toggleEditUserDetailsModalState}
          >
            <CloseIcon />
          </div>
          ...
          <div className="profilePicPreviewNoteBox flexBox">
            <form className="flexBox editUserProfileForm">
              ...
              <div className="flexBox">
                <input
                  value={updateUserDetails.education}
                  name="education"
                  onChange={handleUpdateChange}
                  autoFocus
                  type="text"
                  placeholder="I studied at..."
                />
              </div>
              <label>Lives</label>
              <div className="flexBox">
                <input
                  value={updateUserDetails.lives}
                  name="lives"
                  onChange={handleUpdateChange}
                  type="text"
              ...
              <div className="flexBox">
                <select
                  value={updateUserDetails.relationship}
                  name="relationship"
                  onChange={handleUpdateChange}
                >
            ...
            <div className="userProfilePicEditOptionsBox updateDetailsLoading">
              <button disabled={true}>
                <DisappearedLoading
                  color="#1877f2"
                  size="small"
                  style={{ width: `40px`, height: `0`, marginLeft: "6px" }}
                />
              </button>
            </div>
          </div>
